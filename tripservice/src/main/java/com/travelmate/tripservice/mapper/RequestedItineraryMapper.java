...
public class RequestedItineraryMapper {
    public static TripRequest.RequestedItinerary toRequestedItinerary(Itinerary itinerary) {
        ...
        return TripRequest.RequestedItinerary.builder()
                .id(itinerary.getId() != null ? itinerary.getId().toString() : null)
                .itineraryName(itinerary.getItineraryName())
                .itineraryDescription(itinerary.getDescription())
                .mainDestination(itinerary.getDestination())
